...
Vec2<int> WorldController::get_selected_tile_relative_position() const
{
...
{
    Vec2<int> relative_position = tile->relative_position;
...
bool WorldController::is_point_inside_area(Vec2<int> point) const
{
...
void WorldController::reset_selected()
{
    ...
    Vec2<int> relative_position = this->get_selected_tile_relative_position();
...
{
    this->reset_selected();
    Vec2<int> relative_mouse_position = get_relative_position(mouse_position.x, mouse_position.y);
