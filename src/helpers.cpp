...
Vec2<int> get_absolute_position(int x, int y)
{
    return Vec2<int>{WORLD_OFFSET_X + ((x * TILE_WIDTH / 2) - (y * TILE_WIDTH / 2)), WORLD_OFFSET_Y + ((y * TILE_HEIGHT /2) + (x * TILE_HEIGHT / 2))};
}

Vec2<int> get_relative_position(int x, int y)
{
    Vec2<int> position{};
